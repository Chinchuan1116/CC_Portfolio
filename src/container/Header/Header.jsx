...
const Header = () => {
  ...
  return (
        ...
        <div className='app__header-badge'>
          <div className='badge-cmp app__flex'>
            ...
            <div style={{marginLeft:20}}>
              ...
              <h1 className='head-text'>CC Lim</h1>

            </div>
          </div>
          <div className='tag-cmp app__flex'>
            <p className='p-text'>Web Developer</p>
            <p className='p-text'>Cyber Security Engineer</p>
          </div>
        </div>
      </motion.div>

      <motion.div whileInView={{opacity:[0,1]}} transition={{duration:0.5,delayChildren:0.5}} className='app__header-img'>
        <img id='hero' src={images.hero} alt='profile_bg'/>
    ...
    >
      {[images.javascript, images.react, images.php].map((circle, index) => (
