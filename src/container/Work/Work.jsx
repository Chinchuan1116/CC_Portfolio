...
import './Work.scss'
import {AiFillEye, AiFillEyem, AiFillGithub} from 'react-icons/ai'
  ...
  return (
    <>
      ...
      <div className='app__work-filter'>
        {['All','UI/UX','Web App','Frontend','React JS','3D'].map((item,index)=>(
      ...
      <motion.div animate={animateCard} transition={{duration:0.5,delayChildren:0.6}} className='app__work-portfolio'>
